...
header_frame = ctk.CTkFrame(app, fg_color="#7B623D", height=120, corner_radius=0)
...
navbar = ctk.CTkFrame(app, fg_color="#E6E6E6", height=60, corner_radius=0)
navbar.pack(fill="x", pady=(10, 10))
...
for label in ["HOME", "EVENT SERVICES"]:
    ctk.CTkButton(nav_left, text=label, fg_color="transparent", hover_color="#D6D6D6", text_color="black", font=("Inria Serif", 30), width=130, height=40).pack(side="left", padx=15)

for label in ["SIGN UP", "LOGIN"]:
    ctk.CTkButton(nav_right, text=label, fg_color="transparent", hover_color="#D6D6D6", text_color="black", font=("Inria Serif", 30), width=130, height=40).pack(side="left", padx=15)

# Image section
image_frame = ctk.CTkFrame(app, fg_color="white", height=336, corner_radius=0)
...
# Welcome Section
welcome_frame = ctk.CTkFrame(app, fg_color="#7B623D", height=120, corner_radius=0)
...
bottom_frame = ctk.CTkFrame(app, fg_color="#7B623D", height=200, corner_radius=0)
bottom_frame.pack(fill="x", pady=(0, 0))

mission = ctk.CTkFrame(bottom_frame, fg_color="#7B623D", width=370)
contact = ctk.CTkFrame(bottom_frame, fg_color="#7B623D", width=370)
share = ctk.CTkFrame(bottom_frame, fg_color="#7B623D", width=370)
